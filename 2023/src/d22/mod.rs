...
mod tests {
    ...
    #[test]
    fn test_fn1_example() {
        assert_eq!(fn1(include_str!("../../../input/2023/d22/example.txt")), load_spec(include_str!("../../../input/2023/d22/example-spec.1.txt")));
    }

    #[test]
    fn test_fn1_input() {
        assert_eq!(fn1(include_str!("../../../input/2023/d22/input.txt")), load_spec(include_str!("../../../input/2023/d22/input-spec.1.txt")));
    }

    #[test]
    fn test_fn2_example() {
        assert_eq!(fn2(include_str!("../../../input/2023/d22/example.txt")), load_spec(include_str!("../../../input/2023/d22/example-spec.2.txt")));
    }

    #[test]
    fn test_fn2_input() {
        assert_eq!(fn2(include_str!("../../../input/2023/d22/input.txt")), load_spec(include_str!("../../../input/2023/d22/input-spec.2.txt")));
    }
